...
namespace Service_20180140097_Ricki
{
    ...
    public class TI_UMY : ITI_UMY
    {
        ...
        {
            string msg = "GAGAL";
            SqlConnection sqlcon = new SqlConnection("Data Source = DESKTOP-Q6TINDB; Initial Catalog =\"TI_UMY\"; Persist Security Info = True; User ID =sa; Password =123ricki");
        ...
        public List<Mahasiswa> GetAllMahasiswa()
        {
            ...
            SqlConnection con = new SqlConnection("Data Source = DESKTOP-Q6TINDB; Initial Catalog =\"TI_UMY\"; Persist Security Info = True; User ID =sa; Password =123ricki");
